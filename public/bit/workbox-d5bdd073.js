define("./workbox-d5bdd073.js", ["exports"], function (t) {
  "use strict";
  try {
  ...
  function y(t) {
    ...
    return r.searchParams.set(p, e), { cacheKey: r.href, url: i.href };
  }
  class g {
    constructor() {
      (this.updatedURLs = []),
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const i = Object.assign(Object.assign({}, n), {
                ...
                o = await t.keys(e, i);
              for (const e of o) if (r === q(e.url, s)) return t.match(e, n);
  ...
  class x {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        r = new E(this, { event: e, request: s, params: n }),
        i = this.q(r, s, e);
  ...
  (t.NavigationRoute = class extends r {
    ...
    (t.createHandlerBoundToURL = function (t) {
      return k().createHandlerBoundToURL(t);
    }),
